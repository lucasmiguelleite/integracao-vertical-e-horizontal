...
% Configurar profundidade da numeração
\setcounter{secnumdepth}{2}
\setcounter{tocdepth}{2}

% Remover páginas em branco entre capítulos
\makeatletter
\@openrightfalse
\makeatother

% Reduzir tamanho da fonte dos títulos dos capítulos
\makeatletter
...
\section{Sensoriamento e IoT (Internet das Coisas)}
...
\section{Acionamentos e Controle}
...
\section{Protocolos e Interoperabilidade}
...
\chapter{SISTEMAS CORPORATIVOS E MES}
...
\section{Sistemas MES (Manufacturing Execution Systems)}
...
\section{Inteligência Artificial Industrial (BirminD)}
